...
export const MANAGED_PROVIDERS = PROVIDERS
export class KeyStore {
  ...
  get(provider: Provider): string | undefined {
    if (this.managedKeys && (MANAGED_PROVIDERS as readonly Provider[]).includes(provider)) return process.env[envNames[provider]] || undefined
