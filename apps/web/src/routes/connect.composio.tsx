...
export const Route = createFileRoute('/connect/composio')({
  validateSearch: (search: Record<string, unknown>) => ({ toolkit: typeof search.toolkit === 'string' ? search.toolkit : 'gmail', approval: typeof search.approval === 'string' ? search.approval : undefined, scope: search.scope === 'workspace' ? 'workspace' as const : 'member' as const }),
