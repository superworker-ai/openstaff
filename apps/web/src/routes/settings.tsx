...
import { Bot, ChartBar, Clock, Cpu, KeyRound, Monitor, Plug, Puzzle, ShieldCheck, SunMoon, UserRoundCog, type LucideIcon } from 'lucide-react'
...
const settingsSectionIds = ['providers', 'models', 'appearance', 'security', 'usage', 'plugins', 'connections', 'automations', 'computer', 'members', 'bots'] as const
