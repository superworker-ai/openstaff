...
import { Bot, ChartBar, Clock, Cpu, FlaskConical, KeyRound, Monitor, Plug, Puzzle, ShieldCheck, SunMoon, UserRoundCog, type LucideIcon } from 'lucide-react'
...
const settingsSectionIds = ['providers', 'models', 'appearance', 'security', 'usage', 'plugins', 'connections', 'automations', 'computer', 'members', 'bots', 'experimental'] as const
type SettingsSection = typeof settingsSectionIds[number]
type SettingsRenderProps = { workspace: WorkspaceSettings; user: User }
type SettingsEntry = { id: SettingsSection; label: string; icon: LucideIcon; group: 'Workspace' | 'Integrations' | 'Runtime' | 'Team' | 'Labs'; ownerOnly?: boolean; administratorOnly?: boolean; render: (props: SettingsRenderProps) => ReactNode }
