...
export const Route = createFileRoute('/signup')({
  loader: async () => { const config = await loadAuthConfig(); if (config.signup === 'invite' && !config.bootstrap) throw redirect({ to: '/login' }); return config },
